...
public class FileSystemTestResourceService extends FileSystemResourceService {
	...
	/* (non-Javadoc)
	 * @see com.intuit.tools.imat.io.FileSystemResourceService#getAppScript(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.intuit.tools.imat.io.FileSystemResourceService#getTargetDir()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.intuit.tools.imat.io.FileSystemResourceService#getDevResourcesDir()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.intuit.tools.imat.io.FileSystemResourceService#getScriptsDir()
	 */
	@Override
