...
public class PropertyFileConfigurationService implements IConfigurationService,
	...
	/* (non-Javadoc)
	 * @see com.intuit.ginsu.IConfigurationService#shouldSkipExitStatus()
	 */
